    ...
    <body>
        ...
        <?php
            if(isset($_POST["submit"])){
                ...
                $sql="INSERT INTO `need_blood`(`Name`, `Gender`, `Blood Group Type`, `Need Unit of Blood`, `Hospital Address`, `Doctor Name`, `Required Date`, `Email`, `Contact Number`, `Reason`) VALUES 
