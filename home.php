    ...
    <div id="container">   
        ...
        <div class="out_box">
            ...
            <div class="box">
                ...
                <button type="submit" name="view" onclick="location.href='need_blood_form.php'">View more</button>
            </div>
            <div class="box">
                <h2>Search Donor</h2>
                ...
                <button type="submit" name="search" onclick="location.href='search_donors_form.php'">Search donor</button>
            </div>
        </div>
    </div>
</body>
